export const cmdMap = {
  ...
  socials: {
    ...
    action: () => [
      ...
      `<a href="https://tryhackme.com/p/hadeyghoptey" target="_blank" rel="noopener noreferrer" style="color:#E43F3F; text-decoration:none; transition: color 0.3s ease;" onmouseover="this.style.color='#ff5c5c'" onmouseout="this.style.color='#E43F3F'">TryHackMe: <span style="color:#b5651d; transition: color 0.3s ease;" onmouseover="this.style.color='#d4825a'" onmouseout="this.style.color='#b5651d'">sadistic.keed</span></a>`,
    ],
  },
