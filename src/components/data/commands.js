export const cmdMap = {
  ...
  socials: {
    ...
    action: () => [
      ...
      `<a href="https://github.com/sadistic2keed" target="_blank" rel="noopener noreferrer" style="color:#333; text-decoration:none; transition: color 0.3s ease;" onmouseover="this.style.color='#777'" onmouseout="this.style.color='#333'">GitHub: <span style="color:#b5651d; transition: color 0.3s ease;" onmouseover="this.style.color='#d4825a'" onmouseout="this.style.color='#b5651d'">sadistic2keed</span></a>`,
